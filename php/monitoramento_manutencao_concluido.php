...
<body>
    ...
    <section id="trens">
        ...
        <div id="divbody"> <!--Essa div mostra os status do trem-->
            ...
            <div id="table5">
                <h3>Troca do motor feita dia 25/03</h3>
                <hr>
                <h3>Troca dos Bancos efetuada dia 24/02</h3>
                <hr>
                <h3>Retirada da ratazana feita dia 12/01</h3>
                <hr>
                <h3>Troca do parabriza efetuada dia 14/02</h3>
                <hr>
                <h3>Descarte efetuado dia 19/05</h3>
            </div>
        </div>
